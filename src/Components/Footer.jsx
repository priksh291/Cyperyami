...
const Footer = () => {
  return (
    <div className="relative top-80 mt-40">
      <div className="flex bg-gray-100 rounded-md items-center pl-6 gap-40">
        ...
        <div className="flex gap-40">
          ...
          <div>
            <ul>
              <li>
                <h1 className="text-xl font-semibold">For Business</h1>
              </li>
